...
// For View Student Button
const [ViewStudents, SetViewStudentsDisplay] = useState();
const [SetViewStudentsBtn, SetViewStudentsBtnBg] = useState();
...
// To get all students data from API
...
// Key Up for validation of Profile Page
const [updateProfileBtn, setUpdateProfileBtn] = useState()
const [updateProfileBtnDisabled, setUpdateProfileBtnDisabled] = useState(true)
...
// Toggle Password Button Function
...
// To show search button and become cancel button
function searchShow() {
...
// To hide cancel button and become search button
...
// Grade Levels Count via API
const [gradeLevel1 , totalGradeLevel1] = useState();
const [gradeLevel2 , totalGradeLevel2] = useState();
const [gradeLevel3 , totalGradeLevel3] = useState();
const [gradeLevel4 , totalGradeLevel4] = useState();
const [gradeLevel5 , totalGradeLevel5] = useState();
const [gradeLevel6 , totalGradeLevel6] = useState();

function gradeLevel() {
    fetch('http://localhost:3000/grade-count', {
        method: 'get',
    }).then((data) => {
        return data.json()
    }).then((data) => {
        totalGradeLevel1(data.GradeLevel1)
        totalGradeLevel2(data.GradeLevel2)
        totalGradeLevel3(data.GradeLevel3)
        totalGradeLevel4(data.GradeLevel4)
        totalGradeLevel5(data.GradeLevel5)
        totalGradeLevel6(data.GradeLevel6)
    })
}
            ...
            <div id="db" style={{display: Dashboard ? 'block' : 'none'}} className="container shadow-lg">
                <div className="db">
                    ...
                    <div className="d-flex flex-nowrap justify-content-between">
                        <Link id="linkTest" to={'/Home/Boy-Students'}>
                            <div className="first card col">
                        ...
                        <Link id="linkTest" to={'/Home/Girl-Students'}>
                            <div className="second card col">
                                <div className="m-3 h-75">
                        ...
                        <Link id="linkTest" onClick={viewStudents}>
                            <div className="third card col w-100">
                                <div className="m-3 h-75">
                    ...
                    <div className="mt-5">
                        <h2>Student Grade Levels</h2>
                        <BarChart grade1={gradeLevel1} grade2={gradeLevel2} grade3={gradeLevel3} grade4={gradeLevel4} grade5={gradeLevel5} grade6={gradeLevel6}/>
                    </div>
                </div>
            </div>
